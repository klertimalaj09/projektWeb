...
import type { Authenticator, EnrollParams, EnrollmentResponse, ChallengeAuthenticatorParams, ChallengeResponse, VerifyParams, EnrollmentFactor, TokenEndpointResponse } from '@auth0/auth0-spa-js';
...
export interface ObservableMfaApiClient {
     ...
     */
    challenge(params: ChallengeAuthenticatorParams): Observable<ChallengeResponse>;
    /**
